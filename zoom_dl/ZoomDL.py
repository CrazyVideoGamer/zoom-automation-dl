...
from zoom_dl.utils import download_recording, replace_existing
from zoom_dl.utils import DownloadInterruptedError, DownloadMissingTimeoutError, DownloadsPageTimeoutError
...
def main():
  ...
  parser.add_argument("--backend", "-b", type=str, choices={"pywinauto", "uiautomation"}, default="pywinauto", help="Backend to use (choose from 'pywinauto', 'uiautomation')")
